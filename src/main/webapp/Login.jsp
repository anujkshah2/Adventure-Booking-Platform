			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="navbarsFurni">
					...
					<ul class="custom-navbar-cta navbar-nav mb-2 mb-md-0 ms-5">
						<li><a class="nav-link" href="Login.jsp" src="WEB-INF/images/user.svg"></a></li>
						<li><a class="nav-link" href="cart.html"><img src="WEB-INF/images/cart.svg"></a></li>
					</ul>
				</div>
			</div>
  ...
  <div class="row justify-content-center">
	...
	<div class="col-md-8 col-lg-8 pb-4">
						...
						<form action="loginbean.jsp" method="post">
							...
							<button type="button" class="btn btn-success-hover-outline bg-success text-light"><a href="register.jsp">Register here</a></button>
						</form>
...
<!-- End Contact Form -->
		...
		<footer class="footer-section">
			<div class="container relative">
				...
				<div class="sofa-img">
					<img src="WEB-INF/images/sofa.png" alt="Image" class="img-fluid">
				</div>
